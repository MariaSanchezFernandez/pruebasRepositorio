            ...
            this.setupElement = function(t) {
                ...
                null === (n = r.element) || void 0 === n || n.addEventListener("click", function(t) {
                    ...
                    if (e.CONFIG.destroy_target) {
                        // Desaparece el botón con transición gradual
                        r.element.style.transition = "opacity 2s"; // Transición de 2 segundos
                        r.element.style.opacity = "0"; // El botón se hace invisible
                        
                        setTimeout(() => {
                            // Vuelve a aparecer gradualmente después de 3 segundos
                            r.element.style.transition = "opacity 2s"; // Asegura la transición
                            r.element.style.opacity = "1"; // Vuelve a ser completamente visible
                        }, 4000); // El botón se reaparece después de 3 segundos
                    }
                });
            }
            ,
